...
const MarketingPage = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-indigo-200 text-indigo-700 rounded-full uppercase">
          <Medal className="h-6 w-6 mr-2" />
          No 1 Task Management
        </div>
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
          Tasknest helps team move
        </h1>
        <div
      ...
      >
        ...
        it all with Tasknest.
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Tasknest for free</Link>
      </Button>
    </div>
  );
};
